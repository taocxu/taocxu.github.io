...
def replace_once(text: str, old: str, new: str, label: str) -> str:
    ...
    if count == 0:
        print(f"WARNING: {label}: no match; leaving unchanged")
        return text
    if count > 1:
        print(f"WARNING: {label}: found {count} matches; replacing first only")
...
html = replace_once(html, '''<p>Honoured by <a href="http://sxx.youth.cn/zytz/hdgg/202112/W020211223591937418265.pdf">National Excellent Team Award, Provincial Special Team Award, NUFE Best Report Award 1st Class</a>, National ‘Bringing Culture, Science &amp; Health to Rural China’ Programme, Nanjing University of Finance and Economics</p>''', '''<p>Honoured by <a href="http://sxx.youth.cn/zytz/hdgg/202112/W020211223591937418265.pdf">National Excellent Team Award, Provincial Special Team Award, NUFE Best Report Award 1st Class</a>, Directed by Weiwei Zhu, National ‘Bringing Culture, Science &amp; Health to Rural China’ Programme, Nanjing University of Finance and Economics</p>''', "cultural heritage project direction")
...
html = replace_once(html, 'Organisational Theory &amp; Methodology: Race, Equity, and Power in Organisations, PhD - Stanford University, Jul 2026', 'Organisational Theory &amp; Methodology: Race, Equity, and Power in Organisations, PhD - <a href="https://ccsre.stanford.edu/research-institute/summer-research-methods-seminar/2026-summer-seminar">Stanford University</a>, Jul 2026', "Stanford link")
html = replace_once(html, 'Emerging Issues in Law: AI, Crypto &amp; Global Change, Adv - University of Bradford, Jun 2026', 'Emerging Issues in Law: AI, Crypto &amp; Global Change, Adv - <a href="https://www.bradford.ac.uk/events/whats-on/law-social-sciences-summer-school/">University of Bradford</a>, Jun 2026', "Bradford link")
...
html = replace_once(html, 'International Business Management, Prof David French - <a href="https://www.ucla.edu">UCLA</a> &amp; <a href="https://www.usj.edu.mo/en/">University of Saint Joseph</a>, Jan 2022 · <a href="RoP&amp;Transcript.pdf">[Certificate-Excellent A]</a>', 'International Business Management, Prof David French - <a href="https://www.ucla.edu">UCLA</a> &amp; <a href="https://www.usj.edu.mo/en/">University of Saint Joseph</a>, Jan 2022 (Jiangsu Provincial Government Scholarship for Overseas Studies)', "UCLA scholarship and certificate removal")
html = replace_once(html, 'Economic and Mathematical Modelling - Chinese Society for Optimisation &amp; Economic Mathematics, 2021 · <a href="CertificateMMCM.pdf">[Certificate]</a>', 'Economic and Mathematical Modelling - Chinese Society for Optimisation &amp; Economic Mathematics, 2021', "modelling certificate removal")
html = replace_once(html, '<li><a href="https://www.sps.ed.ac.uk/news-events/event/when-state-your-landlord-precarity-urban-agriculture-accra">Edinburgh CAS, Landlord State and Precarious Urban Agriculture in Accra</a></li>', '<li>Landlord State and Precarious Urban Agriculture in Accra, <a href="https://www.sps.ed.ac.uk/news-events/event/when-state-your-landlord-precarity-urban-agriculture-accra">Centre of African Studies, The University of Edinburgh</a>, 2024</li>', "Edinburgh landlord seminar")
html = replace_once(html, '<li><a href="https://www.sps.ed.ac.uk/news-events/event/political-economy-extractivist-development-ghana">Edinburgh CAS, Political Economy of Extractivist Development in Ghana</a></li>', '<li>Political Economy of Extractivist Development in Ghana, <a href="https://www.sps.ed.ac.uk/news-events/event/political-economy-extractivist-development-ghana">Centre of African Studies, The University of Edinburgh</a>, 2023</li>', "Edinburgh extractivism seminar")
html = replace_once(html, '<li><a href="https://www.sps.ed.ac.uk/news-events/event/global-politics-african-identity-pan-africanism-and-challenge-afropolitanism">Edinburgh CAS, Global Politics of African Identity: Pan-Africanism &amp; Afropolitanism</a></li>', '<li>Global Politics of African Identity: Pan-Africanism &amp; Afropolitanism, <a href="https://www.sps.ed.ac.uk/news-events/event/global-politics-african-identity-pan-africanism-and-challenge-afropolitanism">Centre of African Studies, The University of Edinburgh</a>, 2023</li>', "Edinburgh identity seminar")
...
html = replace_once(html, 'Shanghai, Jiangsu, Kunshan, and Shuyang Governments as well as Affiliated Public Bodies', 'Shanghai, Jiangsu, Kunshan, Shuyang Governments and Affiliated Public Bodies', "government support wording")
...
css = replace_once(css, '''.influence-list {
  display: grid;
...
css = replace_once(css, '''.influence-list li {
  position: relative;
  min-width: 0;
...
css = replace_once(css, '''.timeline-item:first-child { border-top: 0; padding-top: 0; }
.timeline-date { color: var(--muted); font-size: 0.91rem; font-weight: 700; }''', '''.timeline-item:first-child { border-top: 0; padding-top: 0; }
#cv .timeline-item { grid-template-columns: 112px minmax(0, 1fr); gap: 16px; }
.timeline-date { color: var(--muted); font-size: 0.91rem; font-weight: 700; }''', "education timeline spacing")
...
inventory = replace_once(inventory, '17. `Chinese Academy of Sciences` was expanded to `University of Chinese Academy of Sciences` while retaining the same UCAS destination.', '''17. `Chinese Academy of Sciences` was expanded to `University of Chinese Academy of Sciences` while retaining the same UCAS destination.
...
25. The African Identity seminar link was moved from the full seminar title to `Centre of African Studies, The University of Edinburgh`.''', "inventory replacement log")
